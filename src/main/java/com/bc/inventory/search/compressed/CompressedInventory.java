 ...
 */
public class CompressedInventory implements Inventory {
    ...
    private static final String INDEX_FILENAME = "compressed_index";
    ...
    public CompressedInventory(StreamFactory streamFactory) {
        this(streamFactory, false, DEFFAULT_MAX_LEVEL);
    }

    public CompressedInventory(StreamFactory streamFactory, boolean indexOnly, int maxLevel) {
    ...
    static class BitmapIndex extends Index {
        ...
        public boolean containsPoint(int productIndex, S2Point point) {
            ...
            int[] coverage = dbReader.getBitmap(bitmapIndex);
